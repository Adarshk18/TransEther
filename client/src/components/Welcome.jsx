...
const Welcome = () => {
    ...
    return ( <
        ...
        Transact with anyone, anywhere.Buy, sell & send cryptocurrency on TransEther, the borderless exchange. <
        /p> {
            !currentAccount && ( <
                button type = "button"
        ...
        div >
        <
        p className = "text-white font-light text-sm" > { shortenAddress(currentAccount) } <
        /p> <
